...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HaxeUI", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HaxeUI", null, 1920, 1080);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "116";
		app.meta["company"] = "Denyska";
		app.meta["file"] = "HaxeUI";
		app.meta["name"] = "HaxeUI";
		app.meta["packageName"] = "HaxeUI";
